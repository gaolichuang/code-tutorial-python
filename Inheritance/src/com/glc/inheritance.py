...
class subclass(base):
    def __init__(self,who):
        '''you can use "super(subclass,self)"
        because the base inherit from object, otherwise
        it will report "error TypeError: must be type, not classobj"'''
        super(subclass,self).__init__(who)
        print('I am in subclass')
        print('XXXXX%s'%self.who)
